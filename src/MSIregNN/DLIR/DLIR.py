...
class Linear(layers.Layer):
    ...
    :param is_transformer_regressor: If True, initializes weights with zeros and uses a trainable bias based on a
        transformer regressor approach. If False, initializes weights with random values and uses a trainable bias
        initialized with zeros.
    :type is_transformer_regressor: bool

    :ivar w: Weight matrix for the linear transformation.
    :vartype w: tf.Variable

    :ivar b: Bias vector for the linear transformation.
    :vartype b: tf.Variable
    ...
    def call(self, inputs):
        ...
        :param inputs: Input data to be transformed.
        :type inputs: tf.Tensor

        :return: Output of the linear transformation.
        :rtype: tf.Tensor
        """
